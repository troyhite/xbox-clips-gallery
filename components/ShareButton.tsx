  ...
  return (
    <div className="relative">
      <button
        ...
        className="bg-green-600 hover:bg-green-700 text-white text-sm px-3 py-1 rounded transition flex items-center gap-1"
        title="Share"
      >
      ...
      {showMenu && (
        <>
          ...
          />
          <div className="absolute right-0 top-full mt-2 w-56 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-20 py-2">
            <button
              onClick={(e) => {
                e.stopPropagation();
                handleCopyLink();
